<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">Laravel Backend</h5> <button type="button" class="btn-close"
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" aria-current="page"
                        ...
                        <i class="bi bi-cart"></i>Reviews
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" aria-current="page"
                        href="{{ route('admin.users.index') }}">
                        <i class="bi bi-cart"></i>Users
                    </a>
                </li>
            </ul>
            <hr class="my-3">
