...
<?php if( preg_match("~\^|^1[1-9]~", $laravel_version ) ): ?>
...
<?php if(in_array($octane, ['frankenphp', 'roadrunner', 'swoole'])): ?>
<?php echo $__env->make('octane-'.$octane, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>

<?php if( $filament && intval($filament) >= 3 ): ?>
...
# 5. Setup Entrypoint
<?php if($frankenphp_binary): ?>
<?php echo $__env->make('frankenphp.builder', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php else: ?>
EXPOSE 8080
<?php endif; ?>

ENTRYPOINT ["/entrypoint"]
<?php /**PATH phar:///Users/yuki/gitplayground/testtest/laravel-react-e-commerce/vendor/fly-apps/dockerfile-laravel/builds/dockerfile-laravel/resources/views/dockerfile.blade.php ENDPATH**/ ?>